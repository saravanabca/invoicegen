$(document).ready(function () {
    ...
    function send_invoice_data() {
        ...
        AjaxSubmit(formData, baseUrl + "/invoice_create", "POST");
    }
        ...
        <div class="row mt-3">
            <div class="col col-md-2">
                <div class="product_border_input">
                    <input type="text" name="product_name" placeholder="Enter Product Name" class="product_name" id="">
                </div>
                <div class="mt-2">
            ...
            <div class="col col-md-2 position-relative">
                <div class="product_border_input product_border_qua">
                    ...
                    <select name="product_quantity_type" id="" class="product_qua_type">
            ...
            <div class="col col-md-1 position-relative">
                <div class="product_border_input">
                    <select name="product_gst" id="" class="product_gst product_gst_type">
            ...
            <div class="col col-md-2 position-relative">
                <div class="product_border_input product_border_discount">
                    ...
                    <select name="product_discount_type" id="" class="product_discount_type">
                        <option value="%">%</option>
                        <option value="₹">₹</option>
                    </select>
                </div>
