<div class="modal " id="document_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
aria-labelledby="staticBackdropLabel" aria-hidden="false">
<div class="modal-dialog company-dialog modal-l">
    <div class="modal-content">
        <p class="company_add_title">Document Setting</p>
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex mt-4">
                            <div class="ms-auto">
                                ...
                                <button type="submit" class="save_document_details">Update</button>
                            </div>
